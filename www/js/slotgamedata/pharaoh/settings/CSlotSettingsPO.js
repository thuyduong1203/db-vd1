...
function CSlotSettingsPO(my){
    ...
    var _initSymbolAnims = function () {
        ...
        my.slotSettings.s_iSymbolAnims[0] = 1;
        my.slotSettings.s_iSymbolAnims[1] = 1;
        my.slotSettings.s_iSymbolAnims[2] = 1;
        my.slotSettings.s_iSymbolAnims[3] = 1;
        my.slotSettings.s_iSymbolAnims[4] = 1;
        my.slotSettings.s_iSymbolAnims[5] = 1;
        my.slotSettings.s_iSymbolAnims[6] = 1;
        my.slotSettings.s_iSymbolAnims[7] = 1;
        my.slotSettings.s_iSymbolAnims[8] = 1;
        my.slotSettings.s_iSymbolAnims[9] = 1;
        my.slotSettings.s_iSymbolAnims[10] = 1;
        my.slotSettings.s_iSymbolAnims[11] = 1;
        //my.slotSettings.s_iSymbolAnims[12] = 1;
