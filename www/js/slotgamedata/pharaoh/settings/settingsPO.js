...
function SettingsPO() {
    ...
    this.REEL_OFFSET_X = 381;
    this.REEL_OFFSET_Y = 204.5;

    this.NUM_REELS = 5;
    this.NUM_ROWS = 3;
    this.NUM_SYMBOLS = 13;

    this.FREESPIN_SYMBOL = 10;
    this.BONUS_SYMBOL = 9;


    this.SCATTER_SYMBOL = 10;
    this.WILD_SYMBOL = 11;
    ...
    this.SPACE_BETWEEN_SYMBOLS = 20;
    this.SPACE_HEIGHT_BETWEEN_SYMBOLS = 5;
    ...
    this.TIME_DELAY_UPDATE_BETWEEN_2_REEL = 100;
    this.NUM_INFO_PAGES = 7;
...
//this.IS_ENGLISH = false;
    ...
    this.TIMER_RUN_ANIMATION_TEXT_WIN_PANNEL = 4500;
    this.TIMER_WAITING_TEXT_WIN_PANEL = 2000;
    this.TIMER_RUN_ANIMATION_TEXT_WIN_PANNEL_FAST = 1000;
    this.TIMER_WAITING_TEXT_WIN_PANEL_FAST = 6000;
