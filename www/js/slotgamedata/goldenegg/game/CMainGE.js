...
function CMainGE(my, oData) {
    ...
    this.initContainer = function () {
        this.GameConstant = new GameConstant("GoldenEggs");
    ...
    this._initSounds = function () {
        ...
        ManagerForSound.addSoundToQueue('soundtrack_dbUp','img/slotgamedata/goldenegg/sounds/Bonus ,DoubleUp-BG-music.mp3');
        ManagerForSound.addSoundToQueue('soundtrack','img/slotgamedata/goldenegg/sounds/Main-BG-music.mp3');
        ManagerForSound.addSoundToQueue('soundtrack_bonus','img/slotgamedata/goldenegg/sounds/Free Spins-BG-music.mp3');
        ManagerForSound.addSoundToQueue('reel_stop','img/slotgamedata/goldenegg/sounds/Reel- stop.mp3');
        ManagerForSound.addSoundToQueue('spin','img/slotgamedata/goldenegg/sounds/Spin.mp3');
        ManagerForSound.addSoundToQueue('tot_win','img/slotgamedata/goldenegg/sounds/Free Spins-totalwinning.mp3');
        ManagerForSound.addSoundToQueue('doubleUpWin','img/slotgamedata/goldenegg/sounds/Double Up- Win.mp3');
        ManagerForSound.addSoundToQueue('doubleUpLose','img/slotgamedata/goldenegg/sounds/Double Up-lose.mp3');
        ManagerForSound.addSoundToQueue('scatterStop','img/slotgamedata/goldenegg/sounds/Scatter Stop.mp3');
        ManagerForSound.addSoundToQueue('bonus_button_click','img/slotgamedata/goldenegg/sounds/Bonus, Double up -selection.mp3');
        ManagerForSound.addSoundToQueue('bonus_button_collect','img/slotgamedata/goldenegg/sounds/Bonus, Double up -collect.mp3');
        ManagerForSound.addSoundToQueue('lotion_failed','img/slotgamedata/goldenegg/sounds/00-button-bonuslotionfailed.mp3');
        ManagerForSound.addSoundToQueue('symbol-0','img/slotgamedata/goldenegg/sounds/symbol 0.mp3');
        ManagerForSound.addSoundToQueue('symbol-1-2-3','img/slotgamedata/goldenegg/sounds/symbol 1,2,3.mp3');
        ManagerForSound.addSoundToQueue('symbol-4-5','img/slotgamedata/goldenegg/sounds/symbol 4,5.mp3');
        ManagerForSound.addSoundToQueue('symbol-6-7','img/slotgamedata/goldenegg/sounds/Symbol 6,7.mp3');
        ManagerForSound.addSoundToQueue('symbol-8','img/slotgamedata/goldenegg/sounds/Symbol 8.mp3');
        ManagerForSound.addSoundToQueue('symbol-9','img/slotgamedata/goldenegg/sounds/Symbol 9.mp3');
        ManagerForSound.addSoundToQueue('symbol-10','img/slotgamedata/goldenegg/sounds/Symbol 10.mp3');
        ManagerForSound.addSoundToQueue('symbol-11','img/slotgamedata/goldenegg/sounds/Symbol 11.mp3');
        ManagerForSound.addSoundToQueue('symbol-12','img/slotgamedata/goldenegg/sounds/Symbol 12.mp3');
    ...
    this._loadImages = function () {
        ...
        ManagerForImage.loadSprite(my,'game-bg', 'img/slotgamedata/goldenegg/sprites/game-bg.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'bg-freespins', 'img/slotgamedata/goldenegg/sprites/bg-freespins.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'gold-egg-option', 'img/slotgamedata/goldenegg/sprites/doubleUp/gold-egg-option.png?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadSpriteSheet(
            my,'but_spin', 'img/slotgamedata/goldenegg/sprites/but_spin.png?' + LobbyConfig.versionDisplay, 237, 303, 4
        );
        ManagerForImage.loadSprite(my,'amount-win', 'img/slotgamedata/goldenegg/sprites/amount-win.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'loading_bonus', 'img/slotgamedata/goldenegg/sprites/Loading BONUS.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'loading_double_up', 'img/slotgamedata/goldenegg/sprites/doubleUp/loading.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'box-freespins-bonus', 'img/slotgamedata/goldenegg/sprites/box-freespins-bonus.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'totalwinning', 'img/slotgamedata/goldenegg/sprites/totalwinning.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'freespins-en', 'img/slotgamedata/goldenegg/sprites/freespins-en.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'multiplier-en', 'img/slotgamedata/goldenegg/sprites/multiplier-en.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'farmer','img/slotgamedata/goldenegg/sprites/farmer.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'lady','img/slotgamedata/goldenegg/sprites/lady.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSpriteSheet(my,
            'start_bonus', 'img/slotgamedata/goldenegg/sprites/start_bonus.png?' + LobbyConfig.versionDisplay, 237, 303, 2
        );
        ManagerForImage.loadSpriteSheet(my,
            'start_freespin', 'img/slotgamedata/goldenegg/sprites/start_freespin.png?' + LobbyConfig.versionDisplay, 237, 303, 2
        );

        ManagerForImage.loadSprite(my,'btn-double-up', 'img/slotgamedata/goldenegg/sprites/btn-double-up.png?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadAtlas(my,
            'static_symbol', 'img/slotgamedata/goldenegg/sprites/atlas/static_symbol.png?' + LobbyConfig.versionDisplay,
            'img/slotgamedata/goldenegg/sprites/atlas/static_symbol.json?' + LobbyConfig.versionDisplay
        );

        this.infoPageArray = [];
        for (var j = 1; j < settings.NUM_INFO_PAGES + 1; j++) {
            ManagerForImage.loadSprite(my,'info_GE_' + j, 'img/slotgamedata/goldenegg/sprites/info_' + j + '.jpg?' + LobbyConfig.versionDisplay);
            this.infoPageArray.push('info_GE_' + j);
        }

        for (var k = 1; k < 25; k++) {
            ManagerForImage.loadSprite(my,'farmer_' + k, 'img/slotgamedata/goldenegg/sprites/animation/farmer/ui_idle_' + (k < 10?'0' + k:k) + '.png?' + LobbyConfig.versionDisplay);
            ManagerForImage.loadSprite(my,'lady_' + k, 'img/slotgamedata/goldenegg/sprites/animation/lady/ui_lady_idle_' + (k < 10?'0' + k:k) + '.png?' + LobbyConfig.versionDisplay);
        }
    ...
    this.loadLinesAndSymbol = function(){
        ...
        for (var k = 1; k < settings.NUM_PAYLINES + 1; k++) {
            ManagerForImage.loadSprite(this.loaderSymbol,'line_' + k, 'img/slotgamedata/goldenegg/sprites/lines/line_' + k + '.png?' + LobbyConfig.versionDisplay, true);
        }

        var i = settings.NUM_SYMBOLS; while (i--) {
            var k = my.slotSettings.s_iSymbolAnims[i]; while (k--) {

                ManagerForImage.loadSprite(this.loaderSymbol,'symbolGE' + i + '_' + (k + 1),
                    'img/slotgamedata/goldenegg/sprites/anim_symbol_' + i + '/symbol' + i + '_' + k + '.jpg?' + LobbyConfig.versionDisplay, true);
    ...
    this.gotoGame = function () {
        if(that.allImagesLoaded && that.finishAPI && that.allSoundLoaded) {
            _oGame = new CGameGE(my, this.gameContainer, _oData);
        }
    };
    /**
     * Destroy loading UI
