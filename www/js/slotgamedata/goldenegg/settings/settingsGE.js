...
function SettingsGE() {
    ...
    this.REEL_OFFSET_X = 364;
    this.REEL_OFFSET_Y = 213;

    this.REEL_BG_OFFSET_X = 369;
    this.REEL_BG_OFFSET_Y = 209;

    this.SYMBOL_SCALE_NORMAL = 1.013;
    ...
    this.WIDTH_REEL = (that.SYMBOL_WIDTH + that.SPACE_BETWEEN_SYMBOLS) * (that.NUM_REELS);
    this.HEIGHT_REEL = (that.SYMBOL_HEIGHT + that.SPACE_HEIGHT_BETWEEN_SYMBOLS) * (that.NUM_ROWS);

    this.REEL_START_Y = that.REEL_OFFSET_Y - that.HEIGHT_REEL;
    this.REEL_ARRIVAL_Y = that.REEL_OFFSET_Y + that.HEIGHT_REEL;

    this.TIME_SHOW_WIN;
    this.TIME_SHOW_ALL_WINS;
    this.TIME_SPIN_BUT_CHANGE = 1000;
    this.NUM_INFO_PAGES = 5;
    this.TIME_HOLD_AUTOSPIN = 1000;
    this.SWIPE_THRESHOLD = 220;
    this.ANIM_SYMBOL_STEPS = 5;
    this.TIME_REFRESH_JACKPOT = 300000;

    this.SCALE_SYMBOL_MAX = 1.5;
    this.SCALE_SYMBOL_MIN = 1;//0.7;
    this.SCALE_SYMBOL_WIN_FROM = 1.03;
    //this.SCALE_SYMBOL_WIN_TO = 1.03;
    this.SCALE_SYMBOL_WIN_TO = 1.6;

    this.FPS = 30;

    this.totalWinTextSize = "80px Skater-Girls-Rock";
    this.spaceVerticalTextTotalWin = 20;
    this.yPositionTextTotalWin = that.CANVAS_HEIGHT * 0.5;
...
//this.IS_ENGLISH = false;
    ...
    this.TIMER_RUN_ANIMATION_TEXT_WIN_PANNEL = 5000;
    this.TIMER_WAITING_TEXT_WIN_PANEL = 3000;
