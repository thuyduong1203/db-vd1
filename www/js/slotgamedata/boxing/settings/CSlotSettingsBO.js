...
function CSlotSettingsBO(my){
    ...
    var _initSymbolAnims = function () {
        ...
        my.slotSettings.s_iSymbolAnims[0] = 25;
        my.slotSettings.s_iSymbolAnims[1] = 25;
        my.slotSettings.s_iSymbolAnims[2] = 25;
        my.slotSettings.s_iSymbolAnims[3] = 25;
        my.slotSettings.s_iSymbolAnims[4] = 25;
        my.slotSettings.s_iSymbolAnims[5] = 25;
        my.slotSettings.s_iSymbolAnims[6] = 25;
        my.slotSettings.s_iSymbolAnims[7] = 25;
        my.slotSettings.s_iSymbolAnims[8] = 25;
        my.slotSettings.s_iSymbolAnims[9] = 25;
        my.slotSettings.s_iSymbolAnims[10] = 25;
        my.slotSettings.s_iSymbolAnims[11] = 25;
        my.slotSettings.s_iSymbolAnims[12] = 25;
