...
function CMainDB(my, oData) {
    ...
    this.initContainer = function () {
        this.GameConstant = new GameConstant("DeepBlue");
        ...
        new CSlotSettingsDB(my);
        var background = my.add.sprite(0 + ManagerForScale.offsetOutOfBounce_1920/3,0,'bg-loading',null,this.s_oAttachSection);
    ...
    this._initSounds = function () {
        ...
        ManagerForSound.addSoundToQueue('soundtrack_dbUp','img/slotgamedata/deepblue/sounds/Bonus ,DoubleUp-BG-music.mp3');
        ManagerForSound.addSoundToQueue('soundtrack','img/slotgamedata/deepblue/sounds/Main-BG-music.mp3');
        ManagerForSound.addSoundToQueue('soundtrack_bonus','img/slotgamedata/deepblue/sounds/Free Spins-BG-music.mp3');
        ManagerForSound.addSoundToQueue('reel_stop','img/slotgamedata/deepblue/sounds/Reel- stop.mp3');
        ManagerForSound.addSoundToQueue('spin','img/slotgamedata/deepblue/sounds/Spin.mp3');
        ManagerForSound.addSoundToQueue('tot_win','img/slotgamedata/deepblue/sounds/Free Spins-totalwinning.mp3');
        ManagerForSound.addSoundToQueue('doubleUpWin','img/slotgamedata/deepblue/sounds/Double Up- Win.mp3');
        ManagerForSound.addSoundToQueue('doubleUpLose','img/slotgamedata/deepblue/sounds/Double Up-lose.mp3');
        ManagerForSound.addSoundToQueue('scatterStop','img/slotgamedata/deepblue/sounds/Scatter Stop.mp3');
        ManagerForSound.addSoundToQueue('bonus_button_click','img/slotgamedata/deepblue/sounds/Bonus, Double up -selection.mp3');
        ManagerForSound.addSoundToQueue('lotion_failed','img/slotgamedata/deepblue/sounds/00-button-bonuslotionfailed.mp3');
        ManagerForSound.addSoundToQueue('symbol-0','img/slotgamedata/deepblue/sounds/symbol 0.mp3');
        ManagerForSound.addSoundToQueue('symbol-1-2-3','img/slotgamedata/deepblue/sounds/symbol 1,2,3.mp3');
        ManagerForSound.addSoundToQueue('symbol-4-5','img/slotgamedata/deepblue/sounds/symbol 4,5.mp3');
        ManagerForSound.addSoundToQueue('symbol-6-7','img/slotgamedata/deepblue/sounds/Symbol 6,7.mp3');
        ManagerForSound.addSoundToQueue('symbol-8','img/slotgamedata/deepblue/sounds/Symbol 8.mp3');
        ManagerForSound.addSoundToQueue('symbol-9','img/slotgamedata/deepblue/sounds/Symbol 9.mp3');
        ManagerForSound.addSoundToQueue('symbol-10','img/slotgamedata/deepblue/sounds/Symbol 10.mp3');
        ManagerForSound.addSoundToQueue('symbol-11','img/slotgamedata/deepblue/sounds/Symbol 11.mp3');
        ManagerForSound.addSoundToQueue('symbol-12','img/slotgamedata/deepblue/sounds/Symbol 12.mp3');
    ...
    this._loadImages = function () {
        ...
        ManagerForImage.loadSprite(my,'game-bg', 'img/slotgamedata/deepblue/sprites/bg-freespins.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'reels', 'img/slotgamedata/deepblue/sprites/reels.png?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadSprite(my,'bg_bonus_fs', 'img/slotgamedata/deepblue/sprites/bonus_freespin/bg_bonus_freespin.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'bg-double-up', 'img/slotgamedata/deepblue/sprites/doubleUp/double-up-bg.jpg?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadSpriteSheet(my,
            'but_spin', 'img/slotgamedata/deepblue/sprites/but_spin.png?' + LobbyConfig.versionDisplay, 239, 303, 4
        );
        ManagerForImage.loadSprite(my,'amount-win', 'img/slotgamedata/deepblue/sprites/amount-win.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'loading_bonus', 'img/slotgamedata/deepblue/sprites/Loading-BONUS.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'loading_double_up', 'img/slotgamedata/deepblue/sprites/doubleUp/loading.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'box-freespins-bonus', 'img/slotgamedata/deepblue/sprites/box-freespins-bonus.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'totalwinning', 'img/slotgamedata/deepblue/sprites/totalwinning.jpg?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'jelly-fish', 'img/slotgamedata/deepblue/sprites/you-win-jelly.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'freespins-en', 'img/slotgamedata/deepblue/sprites/freespins-en.png?' + LobbyConfig.versionDisplay);
        ManagerForImage.loadSprite(my,'multiplier-en', 'img/slotgamedata/deepblue/sprites/multiplier-en.png?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadSpriteSheet(my,
            'start_bonus', 'img/slotgamedata/deepblue/sprites/start_bonus.png?' + LobbyConfig.versionDisplay, 237, 303, 2
        );
        ManagerForImage.loadSpriteSheet(my,
            'start_freespin', 'img/slotgamedata/deepblue/sprites/start_freespin.png?' + LobbyConfig.versionDisplay, 237, 303, 2
        );

        ManagerForImage.loadSprite(my,'btn-double-up', 'img/slotgamedata/deepblue/sprites/btn-double-up.png?' + LobbyConfig.versionDisplay);

        ManagerForImage.loadAtlas(my,
            'static_symbol', 'img/slotgamedata/deepblue/sprites/atlas/static_symbol.png?' + LobbyConfig.versionDisplay,
            'img/slotgamedata/deepblue/sprites/atlas/static_symbol.json?' + LobbyConfig.versionDisplay
        );

        this.infoPageArray = [];
        for (var j = 1; j < settings.NUM_INFO_PAGES + 1; j++) {
            ManagerForImage.loadSprite(my,'info_DB_' + j, 'img/slotgamedata/deepblue/sprites/info_' + j + '.jpg?' + LobbyConfig.versionDisplay);
            this.infoPageArray.push('info_DB_' + j);
        }

        for (var k = 1; k < 48 + 1; k++) {
            ManagerForImage.loadSprite(my,'jellyfish_small_' + k, 'img/slotgamedata/deepblue/sprites/jellyFish_smallanimation/jellyfish_small_00' + k + '.png?' + LobbyConfig.versionDisplay);
        }
    };
    /**
    ...
    this.loadLinesAndSymbol = function(){
        ...
        for (var k = 1; k < settings.NUM_PAYLINES + 1; k++) {
            ManagerForImage.loadSprite(this.loaderSymbol,'line_' + k, 'img/slotgamedata/deepblue/sprites/lines/line_' + k + '.png?' + LobbyConfig.versionDisplay, true);
        }

        var i = settings.NUM_SYMBOLS; while (i--) {
            var k = my.slotSettings.s_iSymbolAnims[i]; while (k--) {
                ManagerForImage.loadSprite(this.loaderSymbol,'symbolDB' + i + '_' + (k + 1),
                    'img/slotgamedata/deepblue/sprites/anim_symbol_' + i + '/symbol' + i + '_' + (k + 1) + '.png?' + LobbyConfig.versionDisplay, true);
            }
        }
        //for (var i = 0; i < ; i++) {
        //    for (var k = 0; k < ; k++) {
    ...
    this.gotoGame = function () {
        if (that.allImagesLoaded && that.finishAPI && that.allSoundLoaded) {
            _oGame = new CGameDB(my, this.gameContainer, _oData);
            //if (LobbyConfig.isTestAlgorithmMode) {
            //    //ManagerForDebug.start();
            //}
        }
    };
    /**
    ...
    this.onSpinReceived = function (oXmlDoc) {
        ...
        //if(!LobbyConfig.isTestAlgorithmMode) this.s_oGame.onSpinReceived(aWheels, aWinPosition, aTableWin, _iCurBonus, aBonusPos);
        //else ManagerForDebug.onSpinReceived(aWheels, aWinPosition, aTableWin, _iCurBonus, aBonusPos);
    };
    ...
    this._onDoubleUpReceive = function (oXmlDoc) {
        ...
        if (iStep === 0) {
            ...
            //if(!LobbyConfig.isTestAlgorithmMode) this.s_oGame.onDoubleUpStep1Received(iFinish, iResult, iTotWin);
            //else ManagerForDebug.onDoubleUpStep1Received(iFinish, iResult, iTotWin);
        }
...
//            s_iCredit = parseFloat(oXmlDoc.getElementsByTagName('balance')[0].childNodes[0].nodeValue);
            ...
            //if(!LobbyConfig.isTestAlgorithmMode) this.s_oGame.onBonusFreeSpinStep1Received(iFinish, totalFreeSpins, totalMulty, aWheels);
            //else  ManagerForDebug.onBonusFreeSpinStep1Received(iFinish, totalFreeSpins, totalMulty, aWheels);
        }
    ...
    this._onBonusFreeSpinWithRetriggerReceived = function (oXmlDoc) {
        ...
        //if(!LobbyConfig.isTestAlgorithmMode) this.s_oGame.onBonusFreeSpinStepReceived(iRemainingFreeSpin, iMultyFS, aWinPosition, aWheels, aTableWin, iTotWin);
        //else  ManagerForDebug.onBonusFreeSpinStepReceived(iRemainingFreeSpin, iMultyFS, aWinPosition, aWheels, aTableWin, iTotWin);
    ...
    this._onBonusLotionReceived = function (oXmlDoc) {
        ...
        if (iStep === 0) {
            ...
            //if(!LobbyConfig.isTestAlgorithmMode) this.s_oGame.onBonusLotionStep1Received(iFinish, aWheels);
            //else ManagerForDebug.onBonusLotionStep1Received(iFinish, aWheels);
        }
    };
    /**
     * Deprecated
